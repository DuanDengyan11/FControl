...
ulift = [[thrust;thrust;thrust;thrust;-ff[i]] for i = 1:num_lift]
ulift_r = [[0;0;0;0;-ff[i]] for i = 1:num_lift]
...
uliftm_r = [[0;0;0;0;-ffm[i]] for i = 1:num_lift]
...
obj_lift = [LQRObjective(Q_lift,R_lift,Qf_lift,xliftf[i],N,ulift_r[i]) for i = 1:num_lift]
...
cost_mid_lift = [LQRCost(Q_mid_lift,R_lift,xliftmid[i],uliftm_r[i]) for i = 1:num_lift]
